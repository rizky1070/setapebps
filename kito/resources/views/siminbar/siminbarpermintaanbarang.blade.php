                    ...
                    <div class="mt-8">
                        <div class=" mb-3">
                            ...
                            <div class="w-full md:w-1/2 flex items-center space-x-2 mt-3">
                                ...
                                <!-- Tombol Reset -->
                                <a id="resetButton" href="/siminbarpermintaanbarangadmin" class="ml-2 px-4 py-2 bg-gray-300 text-black rounded-lg hover:bg-gray-400">
                                    Reset
                                </a>
                                ...
                                <table class="min-w-full">
                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        <tr id="{{ $permintaanbarang['id'] }}">
                                            ...
                                            <td class="relative mx-auto max-w-6xl [--arrow-size:5px] [--tooltip-color:white] border-b border-gray-200">
                                                <div id="grid" class=" gap-2  p-4 ">
                                                    <div id="gridItem" class="relative cursor-pointer min-w-40 line-clamp-2 text-xs hover:z-50" data-tooltip="LOOK HERE">{{ $permintaanbarang['orderdate'] }}</div>
                                                </div>
    ...
    function sliderData() {
        return {
            ...
            slides: topBarangs.map(topBarang => ({
                image: topBarang.gambar ? '{{ asset("storage/uploads/images/") }}/' + topBarang.gambar : 'agenkita.png',
        ...
        button.addEventListener('click', function() {
            ...
            fetch(`/siminbarpermintaanbaranguser/${rowId}`) // Ganti URL sesuai dengan endpoint Anda
                ...
                .then(eventData => {
                    ...
                    if (signaturePath && signaturePath.trim() !== "") {
                        // Jika signaturePath ada, ubah src dengan path tanda tangan
                        modalSignature.setAttribute('src', "{{ asset('storage/uploads/images') }}/" + signaturePath);
                        modalSignature.style.display = 'block'; // Tampilkan gambar jika ada tanda tangan
