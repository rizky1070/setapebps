...
<body>
    ...
    <div class=" bg-gray-100 min-h-screen flex items-center justify-center ">
        <div class="m-8 bg-white p-8 rounded shadow-md max-w-md w-full mx-auto">
            <h2 class="text-2xl font-semibold mb-4">Form Daftar Barang Edit</h2>

            <form id="scheduleForm" action="{{ route('siminbardaftarbarang.update', ['id' => $barang['id']]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mt-4">
                    ...
                    <input type="text" id="namabarang" name="namabarang" placeholder="Tulis nama barang" class="mt-1 p-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required value="{{ $barang['namabarang'] }}">
                </div>

                <!-- Deskripsi -->
                <div class="mt-4">
                    <label for="deskripsi" class="block text-sm font-medium text-gray-700">Deskripsi</label>
                    <input type="text" id="deskripsi" name="deskripsi" placeholder="Tulis deskripsi" class="mt-1 p-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" value="{{ $barang['deskripsi']}}">
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="dropzone-file" id="dropzone-label" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600 bg-center bg-cover">
                            ...
                            <input id="dropzone-file" type="file" class="hidden" accept="image/*" name="gambar" />
                        </label>
                    </div>
                </div>
