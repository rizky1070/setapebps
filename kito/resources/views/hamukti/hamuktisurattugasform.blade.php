...
<body>
    ...
    <div class=" bg-gray-100 min-h-screen flex items-center justify-center ">
        <div class="m-8 bg-white p-8 rounded shadow-md max-w-md w-full mx-auto">
            ...
            <form action="{{ route('hamuktisurattugasform.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mt-4 block text-sm font-medium text-gray-700">
                    ...
                    <div class="flex items-center gap-x-2">
                        ...
                        <p class="text-2xl">/</p>
                        <div class="flex-1">
                            <input type="text" id="kodeangka" name="kodeangka" value="9280"
                                class="w-full mt-1 p-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block"
                                readonly required>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-x-2 mt-4">
                        <div class="flex-1">
                            <select id="fungsi" name="fungsi"
                                ...
                                <option value="KEPAL">KEPALA</option>
                            </select>
                        </div>
                        <p class="text-2xl">/</p>
                        <div class="flex-1">
                            <select id="bulan" name="bulan"
                                class="w-full mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required>
                                <option value="" disabled selected>bulan</option> <!-- Placeholder option -->
                ...
                <div class="flex items-center space-x-4 mt-4">
                    ...
                    <div>
                        <label for="presensi-date" class="block mb-2 text-sm font-medium text-gray-900">Tanggal
                            Surat</label>
                        <div class="relative">
                            ...
                            <input datepicker id="default-datepicker" name="tanggalsurat" type="text"
                ...
                <div class="mt-4">
                    ...
                    <select id="user" name="user[]" multiple placeholder="Pilih petugas" autocomplete="off"
                        required>
                    ...
                    <div id="date-range-picker" date-rangepicker class="flex items-center space-x-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="datepicker-range-start" name="tanggalmulai" type="text"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 "
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="datepicker-range-end" name="tanggalselesai" type="text"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 "
                                    placeholder="Pilih tgl selesai" required>
                            </div>
                        </div>
                    </div>
                </div>
