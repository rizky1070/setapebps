        ...
        <div class="flex flex-col flex-1 overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container px-6 py-8 mx-auto">
                    <h3 class="text-3xl font-medium text-gray-700">Surat Masuk</h3>
                    <div class="mt-8">
                        <div class=" mb-3">
                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        <tr id="{{ $suratmasuk['id'] }}">
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm font-medium leading-5 text-gray-900 whitespace-nowrap">{{ $suratmasuk['nosurat'] }}
                                                </div>
                                            ...
                                            <td class="relative mx-auto max-w-6xl [--arrow-size:5px] [--tooltip-color:white] border-b border-gray-200">
                                                <div id="grid" class=" gap-2  p-4 ">
                                                    <div id="gridItem" class="relative cursor-pointer min-w-40 line-clamp-2 text-xs hover:z-50" data-tooltip="LOOK HERE">{{ $suratmasuk['perihal'] }}</div>
                                                </div>
                                            ...
                                            <td class="relative mx-auto max-w-6xl [--arrow-size:5px] [--tooltip-color:white] border-b border-gray-200">
                                                <div id="grid" class=" gap-2  p-4 ">
                                                    <div id="gridItem" class="relative cursor-pointer min-w-40 line-clamp-2 text-xs hover:z-50" data-tooltip="LOOK HERE">{{ $suratmasuk['tglterima'] }}</div>
                                                </div>

                                            </td>
                                            <td class="relative mx-auto max-w-6xl [--arrow-size:5px] [--tooltip-color:white] border-b border-gray-200">
                                                <div id="grid" class=" gap-2  p-4 ">
                                                    <div id="gridItem" class="relative cursor-pointer min-w-40 line-clamp-2 text-xs hover:z-50" data-tooltip="LOOK HERE">{{ $suratmasuk['namainstansi'] }}</div>
                                                </div>

                                            </td>
                                            <td class="relative mx-auto max-w-6xl [--arrow-size:5px] [--tooltip-color:white] border-b border-gray-200">
                                                <div id="grid" class=" gap-2  p-4 ">
                                                    <div id="gridItem" class="relative cursor-pointer min-w-40 line-clamp-2 text-xs hover:z-50" data-tooltip="LOOK HERE">{{ $suratmasuk['namadisposisi'] }}</div>
                                                </div>
                                            ...
                                            <td
                                                ...
                                                @if (auth()->user()->is_leader)
                                                <form action="{{ route('hamuktisuratmasuk.delete', $suratmasuk['id']) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus ini?');" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 space-y-4 max-h-96 overflow-y-auto">
                ...
                <div class="text-base leading-relaxed text-gray-500 dark:text-gray-400" id="event-id">
                    <b>Tanggal:</b>
                    <span id="tglterima"></span>
                </div>

                <div class="text-base leading-relaxed text-gray-500 dark:text-gray-400" id="event-id">
                    <b>Nomor Surat:</b>
                    <span id="nosurat"></span>
                </div>
                <div class="text-base leading-relaxed text-gray-500 dark:text-gray-400" id="event-id">
                    <b>Perihal:</b>
...
detailButtons.forEach(button => {
    button.addEventListener('click', function() {
        ...
        fetch(`/hamuktisuratmasuk/${rowId}`) // Ganti URL sesuai dengan endpoint Anda
            .then(response => {
                if (!response.ok) {
            ...
            .then(eventData => {
                ...
                var modalDateStart = modal.querySelector('#tglterima'); // Pastikan ada elemen dengan ID ini di modal
                modalDateStart.textContent = eventData.tglterima; // Mengganti teks tanggal mulai

                var modalDateEnd = modal.querySelector('#nosurat'); // Pastikan ada elemen dengan ID ini di modal
                modalDateEnd.textContent = eventData.nosurat; // Mengganti teks tanggal selesai
