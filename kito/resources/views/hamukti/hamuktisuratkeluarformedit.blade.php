...
<body>
    ...
    <div class=" bg-gray-100 min-h-screen flex items-center justify-center ">
        <div class="m-8 bg-white p-8 rounded shadow-md max-w-md w-full mx-auto">
            ...
            <form action="{{ route('hamuktisuratkeluar.update', ['id' => $surat['id']]) }}" method="POST"
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="default-datepicker" name="suratkeluardate" type="text"
                                ...
                                placeholder="Pilih tgl" readonly value="{{ $surat['tanggal'] }}">
                        </div>
                ...
                <!-- No Surat -->
                <div class="mt-4">
                    <label for="nomorfull" class="block text-sm font-medium text-gray-700">Perihal</label>
                    <input type="text" id="nomorfull" name="nomorfull"
                        ...
                        required value="{{ $surat['nomorfull'] }}">
                </div>
