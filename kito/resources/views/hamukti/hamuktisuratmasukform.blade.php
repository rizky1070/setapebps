...
<body>
    ...
    <div class=" bg-gray-100 min-h-screen flex items-center justify-center ">
        <div class="m-8 bg-white p-8 rounded shadow-md max-w-md w-full mx-auto">
            ...
            <form action="{{ route('hamuktisuratmasukform.store') }}" method="POST" enctype="multipart/form-data"
                id="form_surat">
                @csrf
                <!-- tanggal terima -->
                ...
                <div class="mt-4 flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input datepicker id="default-datepicker-surat" name="tglsurat" type="text"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 "
                                placeholder="Pilih tgl" required>
                        </div>
                ...
                <div class="mt-4">
                    ...
                    <input type="text" id="nosurat" name="nosurat" placeholder="nomor surat"
                ...
                <div class="mt-4">
                    ...
                    <select id="select-state" name="disposisi[]" multiple placeholder="Select a state..."
...
<script>
    ...
    const modalInstansi = document.getElementById('modalTambahInstansi');
    ...
    cancelButton.addEventListener('click', function() {
        modalInstansi.classList.add('hidden');
    });
    ...
    modalInstansi.querySelectorAll('[data-modal-hide]').forEach(function(button) {
        button.addEventListener('click', function() {
            modalInstansi.classList.add(
