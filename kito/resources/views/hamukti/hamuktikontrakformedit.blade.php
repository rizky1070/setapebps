...
<body>
    ...
    <div class=" bg-gray-100 min-h-screen flex items-center justify-center ">
        <div class="m-8 bg-white p-8 rounded shadow-md max-w-md w-full mx-auto">
            <h2 class="text-2xl font-semibold mb-4">Form Kontrak</h2>

            <form action="{{ route('hamuktikontrak.update', ['id' => $surat['id']]) }}" method="POST"
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="default-datepicker" name="tanggal" type="text"
                                ...
                                placeholder="Pilih tgl" required readonly value="{{ $surat['tanggal'] }}">
                        </div>
                    ...
                    <div class="flex items-center gap-x-2">
                        <div class="flex-1">
                            <input type="text" id="nosurat" name="nosurat"
                                ...
                                required placeholder="no surat" value="{{ $surat['nosurat'] }}" readonly>
                        </div>
                        <p class="text-2xl">/</p>
                        <div class="flex-1">
                            <input type="text" id="kodesurat" name="kodesurat"
                                class="w-full mt-1 p-2 bg-gray-100 border border-gray-300 text-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block"
                                required value="{{ $surat['kodesurat'] }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-x-2 mt-4">
                        <div class="flex-1">
                            <select id="fungsi" name="fungsi"
                                ...
                                <option value="FUNGS" {{ $surat['fungsi'] == 'FUNGS' ? 'selected' : '' }}>FUNGSIONAL
                                </option>
